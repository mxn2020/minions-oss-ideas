...
/**
 * @minions-oss-ideas/cli — CLI for Minions Oss-ideas
 *
...
import { customTypes } from '@minions-oss-ideas/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Oss-ideas'));
        console.log(chalk.dim('Idea brainstorms, feasibility scores, tech stack picks, and market gaps'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-oss-ideas/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-oss-ideas/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-oss-ideas')}`);
