# Manual Setup Steps for Minions Oss-ideas
...
Go to **GitHub → mxn2020/minions-oss-ideas → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-oss-ideas` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-oss-ideas-web`
- **GitHub repo**: `mxn2020/minions-oss-ideas`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `oss-ideas.minions.wtf`

### Documentation
- **Netlify site name**: `minions-oss-ideas-docs`
- **GitHub repo**: `mxn2020/minions-oss-ideas`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `oss-ideas.minions.help`

### Blog
- **Netlify site name**: `minions-oss-ideas-blog`
- **GitHub repo**: `mxn2020/minions-oss-ideas`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `oss-ideas.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `oss-ideas.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `oss-ideas.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `oss-ideas.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-oss-ideas/sdk`](https://www.npmjs.com/package/@minions-oss-ideas/sdk)
- CLI: [`@minions-oss-ideas/cli`](https://www.npmjs.com/package/@minions-oss-ideas/cli)
...
Your package: [`minions-oss-ideas`](https://pypi.org/project/minions-oss-ideas/)
...
| Item | Value |
|------|-------|
| Project | `minions-oss-ideas` |
| SDK (npm) | `@minions-oss-ideas/sdk` |
| CLI (npm) | `@minions-oss-ideas/cli` |
| Python (PyPI) | `minions-oss-ideas` |
| GitHub | `github.com/mxn2020/minions-oss-ideas` |
| Docs domain | `oss-ideas.minions.help` |
| Blog domain | `oss-ideas.minions.blog` |
| App domain | `oss-ideas.minions.wtf` |
