...
- `@minions-oss-ideas/sdk` (npm package)
- `minions-oss-ideas` (PyPI package)
- `@minions-oss-ideas/cli` (npm package)
- The minions-oss-ideas web playground
- The minions-oss-ideas documentation site
